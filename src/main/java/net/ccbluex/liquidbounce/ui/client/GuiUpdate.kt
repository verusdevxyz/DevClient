...
class GuiUpdate : GuiScreen() {
    ...
    override fun initGui() {
        ...
        buttonList.run {
            add(GuiButton(1, width / 2 + 2, j + 24 * 2, 98, 20, "OK"))
            //Fonts.font35.drawCenteredString("Press \"OK\" to continue", width / 2f, height / 8f + 80, 0xffffff)
        }
    }
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        glScalef(2F, 2F, 2F)
        Fonts.fontBold180.drawCenteredString("Press \"OK\" to continue", width / 2f - 140, height / 8f, 0xffffff)
    }
