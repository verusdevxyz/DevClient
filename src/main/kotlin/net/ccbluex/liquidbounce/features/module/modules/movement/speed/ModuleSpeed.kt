...
import net.ccbluex.liquidbounce.features.module.modules.movement.speed.modes.grim.SpeedGrimBoost
import net.ccbluex.liquidbounce.features.module.modules.movement.speed.modes.grim.SpeedGrimCollide
import net.ccbluex.liquidbounce.features.module.modules.movement.speed.modes.grim.SpeedGrimTest
...
object ModuleSpeed : Module("Speed", Category.MOVEMENT) {
    ...
    private fun initializeSpeeds(configurable: ChoiceConfigurable<*>) = arrayOf(
        ...
        SpeedGrimTest(configurable),
        SpeedGrimBoost(configurable),
