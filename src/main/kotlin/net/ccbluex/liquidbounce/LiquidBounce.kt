...
object LiquidBounce : Listenable {
    ...
    const val CLIENT_NAME2 = "Concorde Client"
    const val CLIENT_AUTHOR = "XD?"
    const val CLIENT_CLOUD = "https://cloud.liquidbounce.net/LiquidBounce"

   // val clientVersion = gitInfo["git.build.version"]?.toString() ?: "unknown"
   val clientVersion = "b0.1"
    ...
    val startHandler = handler<ClientStartEvent> {
        runCatching {
            logger.info("Launching $CLIENT_NAME2 v$clientVersion by $CLIENT_AUTHOR")
